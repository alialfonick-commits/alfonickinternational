                    ...
                    {steps.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`absolute top-0 ${item.side === "left"
                                            ? "right-[55%]"
                                            : "left-[55%]"
                                        }`}
                                >
                                    <div
                                        className={`w-87.5 bg-white rounded-[14px] border border-[#E6E6E6] shadow-[0px_4px_24px_rgba(0,0,0,0.08)] p-5 ${item.side === "left"
                                                ? "text-right"
                                                : "text-left"
                                            }`}
                                    >
                                        <div
                                            className={`flex items-center gap-2 mb-5 ${item.side === "left"
                                                    ? "justify-end"
                                                    : "justify-start"
                                                }`}
                                        >
                                            <div className="w-9 h-9 rounded-xl bg-[#FFF2F1] flex items-center justify-center">
                                                <Icon className="size-[18px] text-[#B81C15]" />
                                            </div>
                                ...
                                <div key={index} className="relative pl-20">
                                    ...
                                    <div className="bg-white rounded-[14px] border border-[#ECECEC] shadow-[0px_6px_20px_rgba(0,0,0,0.05)] p-6">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <div className="w-9 h-9 rounded-xl bg-[#FFF2F1] flex items-center justify-center">
                                                <Icon className="size-[14px] text-[#B81C15]" />
                                            </div>
